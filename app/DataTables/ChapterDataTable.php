...
class ChapterDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.chapter.actions.checkbox')
            ->addColumn('edit', 'admin.chapter.actions.edit')
            ->addColumn('delete', 'admin.chapter.actions.delete')
            ->rawColumns([
    ...
    {
        return $this->builder()
        ->setTableId('chapterdatatable-table')
        ...
        ->parameters([
            ...
            'buttons' => [
                [
                    'text' => '<i class="fa fa-plus mr-1"></i> ' . trans('Add Chapter'),
    ...
    protected function getColumns()
    {
        return [
            Column::computed('checkbox')
                ...
                ->printable(false),
            Column::make('id'),
            Column::make('subject_id')->title(trans('Subject ID')),
            Column::make('chapter_name')->title(trans('chapter Name')),
            Column::make('chapter_number')->title(trans('chapter Number')),
