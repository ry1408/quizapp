...
<div class="card">
    ...
    <h3 class="card-title" style="float:none;">Review List</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <?php echo Form::open(['id' => 'form_data', 'url' => aurl('review/destroy/all'), 'method' => 'POST']); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\quizapp\resources\views/admin/reviews/index.blade.php ENDPATH**/ ?>