...
class ClassesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.classes.actions.checkbox')
            ->addColumn('edit', 'admin.classes.actions.edit')
            ->addColumn('delete', 'admin.classes.actions.delete')
            ->rawColumns([
    ...
    public function html()
    {
        ...
        ->parameters([
            ...
            'buttons' => [
                [
                    'text' => '<i class="fa fa-plus mr-1"></i> ' . trans('Add Class'),
    ...
    protected function getColumns()
    {
        return [
            Column::computed('checkbox')
                ...
                ->printable(false),
            Column::make('id'),
            Column::make('class_name')->title(trans('admin.column_name')),
            Column::make('image')->title(trans('Image')),
            Column::make('board_id')->title(trans('Board ID'))->className('text-center')
