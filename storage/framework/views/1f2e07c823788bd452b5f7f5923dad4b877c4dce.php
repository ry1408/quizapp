...
<div class="card">
    ...
    <!-- /.card-header -->
    <div class="card-body">
      <?php echo Form::open(['id' => 'form_data', 'url' => aurl('exam/destroy/all'), 'method' => 'POST']); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\quizapp\resources\views/admin/answers/index.blade.php ENDPATH**/ ?>