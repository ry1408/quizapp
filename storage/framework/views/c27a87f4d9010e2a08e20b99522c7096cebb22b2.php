    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <?php echo e(Form::text('chapter_name', old('name'), ['class' => 'form-control'])); ?>
            ...
            <div class="form-group">
                ...
                <?php echo e(Form::text('chapter_number', old('name'), ['class' => 'form-control'])); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\quizapp\resources\views/admin/chapter/create.blade.php ENDPATH**/ ?>