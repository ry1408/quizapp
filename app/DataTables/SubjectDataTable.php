...
class SubjectDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.subjects.actions.checkbox')
            ->addColumn('edit', 'admin.subjects.actions.edit')
            ->addColumn('delete', 'admin.subjects.actions.delete')
            ->rawColumns([
    ...
    {
        return $this->builder()
        ->setTableId('subjectdatatable-table')
        ...
        ->parameters([
            ...
            'buttons' => [
                [
                    'text' => '<i class="fa fa-plus mr-1"></i> ' . trans('Add Subject'),
    ...
    protected function getColumns()
    {
        return [
            Column::computed('checkbox')
                ...
                ->printable(false),
            Column::make('id'),
            Column::make('class_id')->title(trans('Class ID')),
            Column::make('subject_name')->title(trans('Subject Name')),
