...
class BoardDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'admin.boards.actions.checkbox')
            ->addColumn('edit', 'admin.boards.actions.edit')
            ->addColumn('delete', 'admin.boards.actions.delete')
            ->rawColumns([
     ...
     *
     * @param \App\Model\Board $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Board $model)
    {
    ...
    {
        return $this->builder()
        ->setTableId('boarddatatable-table')
        ...
        ->parameters([
            ...
            'buttons' => [
                [
                    'text' => '<i class="fa fa-plus mr-1"></i> ' . trans('Add board'),
    ...
    protected function getColumns()
    {
        return [
            Column::computed('checkbox')
                ...
                ->printable(false),
            Column::make('id'),
            Column::make('board_name')->title(trans('admin.column_name')),
